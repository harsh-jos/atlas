...
function Badge({ className, variant = 'default', ...props }: BadgeProps) {
  return (
    <span
      className={cn(
        'inline-flex select-none items-center rounded-full border px-2 py-0.5 text-[11px] font-medium transition-colors',
        // Variants
        variant === 'default' && 'border-[var(--hairline)] bg-canvas text-muted',
        variant === 'secondary' && 'border-[var(--hairline)] bg-[#f3f1ed] text-muted',
